...
public class SimulationManager : MonoBehaviour
{
    ...
    //----------------------------------------------------------------
    //Dugum Noklar�ndaki count de�erlerini �ekicez
    ...
    //--------------------------------------------------
    //Buttery ve Resistor De�erleri i�in 
    BatteryVolt batteryVolt;
    ResistorOhm resistorOhm;
    //Etkile�im varsa Triggerlar olu�cak
    ...
    private void Update()
    {
        ...
        //Simulasyon i�in olu�acak durumlar-----------------
        ...
        else if (bulbTrig && wireTrig && reactorTrig && switchTrig)
        {
            ...
            voltText.text = "¡Por favor conecta una fuente de energía a tu circuito!";
        ...
        else if (batteryTrig && bulbTrig && wireTrig && switchTrig)
        {
            if (switchBtncount == 1)
            {
                ...
                resistText.text = "¡¡Advertencia!! Conecta una resistencia al circuito. Los elementos del circuito se dañarán.";
                ...
                if(batteryVolt._batteryVolt == 30f)
                {
                    ...
                    switchKeyObjRenderer.material = switchOnOffMaterials[0];
                    voltText.text = "";
                    resistText.text = "EL INTERRUPTOR Y LA BOMBILLA SE DAÑARON POR ALTO VOLTAJE";
                    amperText.text = "";
                }
            }
            else
