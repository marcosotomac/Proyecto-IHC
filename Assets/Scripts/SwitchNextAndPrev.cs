...
public class SwitchNextAndPrev : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (index == 0)
        {
            ...
            whichResist.text = "Diren� : " + resistors[0].gameObject.GetComponent<ResistorOhm>()._resistorOhm.ToString() + "R";
        }
    ...
    public void Next()
    {
        ...
        for (int i = 0; i < resistors.Length; i++)
        {
            resistors[i].gameObject.SetActive(false);
            resistors[index].gameObject.SetActive(true);
            whichResist.text = "Diren� : " + resistors[index].gameObject.GetComponent<ResistorOhm>()._resistorOhm.ToString() + "R";
        }
